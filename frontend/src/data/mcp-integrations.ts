...
export const mcpIntegrations: MCPIntegration[] = [
  {
    ...
    description: "Official hosted MCP for GitHub; supports OAuth or PAT; capabilities organized into 15 toolsets (repos, PRs, issues, actions, security, etc.)",
    tools: {
      examples: ["repos", "pull_requests", "issues", "actions", "code_security", "dependabot", "discussions", "gists", "notifications", "orgs", "users"],
      descriptions: [
  ...
  },
  {
    ...
    description: "Notion-hosted remote MCP with OAuth; lets AI search, read, create & update workspace content.",
    tools: {
      examples: ["search", "fetch", "create-pages", "update-page", "move-pages", "duplicate-page", "create-database", "update-database", "create-comment", "get-comments", "get-users", "get-user", "get-self"],
      descriptions: [
  ...
  },
  {
    ...
    description: "Sentry-hosted remote MCP (OAuth), with issue context, search, & Seer integration.",
    tools: {
      examples: ["Organizations", "Projects", "Teams", "Issues", "DSNs", "Error Searching", "Seer", "Releases", "Performance", "Custom Queries"],
      count: "16+"
    },
  ...
  },
  {
    ...
    description: "Linear-hosted remote MCP (OAuth 2.1) via SSE/HTTP; find/create/update issues, projects, comments.",
    tools: {
      examples: ["search issues", "create issues", "update issues", "manage projects", "handle comments"],
      count: "22"
    },
  ...
  },
  {
    ...
    description: "Intercom-hosted remote MCP (HTTP & legacy SSE); OAuth or bearer token; US workspaces currently.",
    tools: {
      examples: ["search", "fetch", "search_conversations", "get_conversation", "search_contacts", "get_contact"],
      count: "6"
    },
  ...
  },
  {
    ...
    description: "Open-source MCP for Neon Postgres; managed remote at mcp.neon.tech supports OAuth & API keys; local mode too.",
    tools: {
  ...
  },
  {
    ...
    description: "Remote MCP Server (beta) with OAuth 2.1; surfaces Jira/Confluence/Compass into AI tools (rate-limited by plan).",
    tools: {
  ...
  },
  {
    ...
    description: "Official MCP (remote via OAuth or local); tools for sites, pages, components & CMS.",
    tools: {
      examples: ["sites list/get/publish", "pages get/update", "components list/get/update", "collections", "custom-code", "ask-webflow-ai"],
      count: "20+"
    },
  ...
  },
  {
    ...
    description: "Official Wix MCP (remote helper @wix/mcp-remote to https://mcp.wix.com/sse); OAuth flow; broad Wix solutions.",
    tools: {
