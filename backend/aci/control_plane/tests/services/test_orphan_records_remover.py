...
class TestOrphanRecordsRemoverAllowedTeamsUpdated:
    """Test cases for on_mcp_server_configuration_allowed_teams_updated method"""
    ...
    def test_connected_accounts_removal_by_status(
        self,
        db_session: Session,
        dummy_organization: Organization,
        dummy_user: User,
