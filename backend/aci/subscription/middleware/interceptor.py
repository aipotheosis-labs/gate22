...
from aci.subscription.context import request_id_ctx_var
...
class InterceptorMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: RequestResponseEndpoint) -> Response:
        ...
        if not is_health_check:
            ...
            logger.debug("received request", extra=request_log_data)
        ...
        if not is_health_check:
            ...
            logger.debug("response sent", extra=response_log_data)
